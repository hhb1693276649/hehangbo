from flask import render_template, g, redirect, abort, make_response, request, jsonify, current_app, url_for
...
def user_info():
    ...
    # response = make_response(render_template('news/user.html', user=user))
